...
#Brukte disse under eksperimentering
ALGS1 = [heap.sort, merge.sort]

ALGS2 = [heap.sort, merge.sort]

""" ALGS1 = [bubble.sort, insertion.sort]

ALGS2 = [bubble.sort, insertion.sort] """
...
def runalg(alg, A, i, discarded):
    ...
    timeus = (time.perf_counter() - now) * 1000000
    timems = timeus / 1000
